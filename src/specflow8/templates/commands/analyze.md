...
- After analysis notes are updated, run `specflow8 commit --type docs --scope analyze --subject "analyze [<FEATURE_ID>] 本轮对话完成内容" --body "stage: analyze; feature: <FEATURE_ID>" --footer "Refs: <FEATURE_ID>"`.
